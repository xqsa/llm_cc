"""Run Stage 8.23 CEC2013 F13/F14 frozen-policy multiseed pilot."""
...
from loco.coordination.cec2013_frozen_policy_multiseed_pilot import (  # noqa: E402
...
def main() -> None:
    ...
    summary = run_stage8_23_cec2013_f13_f14_multiseed_pilot(
